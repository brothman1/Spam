CREATE TABLE dbo.tbl_CatalogPermission
	...
	,CONSTRAINT fk_tbl_CatalogPermission_CatalogId
		FOREIGN KEY (CatalogId)
		REFERENCES dbo.tbl_Catalog (Id)
	,CONSTRAINT fk_tbl_CatalogPermission_SecurityGroupId
		FOREIGN KEY (SecurityGroupId)
		REFERENCES ref.tbl_SecurityGroup (Id)
	,CONSTRAINT fk_tbl_CatalogPermission_PermissionId
		FOREIGN KEY (PermissionId)
		REFERENCES ref.tbl_Permission (Id)
	,CONSTRAINT fk_tbl_CatalogPermission_AppendSessionId
		FOREIGN KEY (AppendSessionId)
		REFERENCES dbo.tbl_Session (Id)
	,CONSTRAINT fk_tbl_CatalogPermission_UpdateSessionId
		FOREIGN KEY (UpdateSessionId)
		REFERENCES dbo.tbl_Session (Id)
	)
GO
CREATE UNIQUE NONCLUSTERED INDEX nci_tbl_CatalogPermission_CatalogId_SecurityGroupId_PermissionId on dbo.tbl_CatalogPermission
	(
	CatalogId
	,SecurityGroupId
	,PermissionId
